            ...
            <div className="max-w-4xl w-full px-6 text-center">
                ...
                <div className="flex flex-col md:flex-row gap-10 justify-center items-center max-w-4xl mx-auto">
                    ...
                    <a
                        ...
                        className="group w-80 h-50 bg-[#2a2a2a] rounded-lg p-6 flex flex-col items-start justify-center"
                    >
                        <svg className="w-8 h-8" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a
                        ...
                        className="group w-80 h-50 bg-[#2a2a2a] rounded-lg p-6 flex flex-col items-start justify-center"
                    >
                        <svg className="w-8 h-8" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a
                        ...
                        className="group w-80 h-50 bg-[#2a2a2a] rounded-lg p-6 flex flex-col items-start justify-center"
                    >
                        <svg className="w-8 h-8" stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
