        ...
        <section id="notice" className="min-h-screen flex flex-col justify-center items-center">
            <div className="max-w-4xl w-full px-6 text-center">
                ...
                <div className="flex flex-col md:flex-row gap-10 justify-center items-center max-w-4xl mx-auto">
                    ...
                    >
                        <svg className="absolute top-6 left-6 w-8 h-8" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a
                        ...
                        className="group relative w-80 h-52 bg-[#2a2a2a] rounded-lg p-6 pt-16 block"
                    >
                        <svg className="absolute top-6 left-6 w-8 h-8" stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a
                        ...
                        className="group relative w-80 h-52 bg-[#2a2a2a] rounded-lg p-6 pt-16 block"
                    >
                        <svg className="absolute top-6 left-6 w-8 h-8" stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
